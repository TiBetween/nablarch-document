...
qthelp:
	...
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/Nablarch.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/Nablarch"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/Nablarch"
	@echo "# devhelp"
